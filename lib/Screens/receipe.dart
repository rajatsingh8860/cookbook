...
class Receipe extends StatefulWidget {
  ...
  @override
  ReceipeState createState() => ReceipeState();
}

class ReceipeState extends State<Receipe> {
              ...
              notLoggedIn
                ...
                child: StreamBuilder(
                    stream: FirebaseFirestore.instance
                      ...
                      .doc(_userData['id'].toString())
                        .snapshots(),
                    builder: (context, snapshot) {
                      return (snapshot.data['favourite'] == false)
                          ? InkWell(
                              onTap: () async {
                      ...
                      .doc(_userData['id'].toString())
                                    ...
                                    Fluttertoast.showToast(msg: "${snapshot.data['dishName'].toString()} marked as favourite");
                              },
