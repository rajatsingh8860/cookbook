...
class Notes extends StatefulWidget {
  ...
  const Notes({this.docId, this.dishId});
  ...
  addData() async {
    setState(() {
      ...
      FirebaseFirestore.instance
                        ...
                        .collection('Dishes')
                        .doc(widget.dishId)
                    .collection('comment').doc(_userData['id'].toString()).collection('notes').add({
        'comments': notes.text,
      }).then((value) {
        setState(() {
          uploading = false;
              ...
              child: Container(
                  ...
                  child: StreamBuilder(
                    stream:FirebaseFirestore.instance
                        ...
                        .collection('Dishes')
                        .doc(widget.dishId)
                    .collection('comment').doc(_userData['id'].toString()).collection('notes')
                        .snapshots(),
